...
/// use rinfluxdb::line_protocol::r#async::Client;
///
...
/// use rinfluxdb::line_protocol::r#async::InfluxLineClientWrapper;
///
/// # async_std::task::block_on(async {
...
///
/// // Bring into scope the trait implementation
/// use rinfluxdb::line_protocol::r#async::InfluxLineResponseWrapper;
///
/// # async_std::task::block_on(async {
/// // Create Reqwest client
/// let client = reqwest::Client::new();
