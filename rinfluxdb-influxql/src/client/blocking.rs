...
/// A trait to obtain a prepared InfluxQL request builder from [Reqwest clients](reqwest::blocking::Client).
///
/// This trait is used to attach an `influxql()` function to [`reqwest::blocking::Client`](reqwest::blocking::Client).
///
/// ```no_run
/// # use url::Url;
...
///
/// // Bring into scope the trait implementation
/// use rinfluxdb_influxql::blocking::InfluxqlResponseWrapper;
///
/// // Create Reqwest client
/// let client = reqwest::blocking::Client::new();
///
