...
impl From<crate::types::ResponseError> for crate::flux::response::ResponseError {
    fn from(error: crate::types::ResponseError) -> Self {
        match error {
            crate::types::ResponseError::FluxResponseError(error) => error,
    ...
    E: Into<ResponseError>,
{
    ...
    for payload in payloads {
        ...
        let columns: Vec<_> = izip!(columns.into_iter(), data_types.into_iter(), grouping.into_iter(), default.into_iter())
            .skip(1)
            .collect();
